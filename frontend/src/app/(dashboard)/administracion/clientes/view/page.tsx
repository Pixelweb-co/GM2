...
/**
 * ! If you need data using an API call, uncomment the below API code, update the `process.envBLIC_API_URL` variable in the
...
/* const getPricingData = async () => {
  // Vars
  const res = await fetch(`${process.envBLIC_API_URL}/pages/pricing`)
