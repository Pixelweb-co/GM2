     ...
     const {
      ...
      const onSubmit = async (data: any) => {
        ...
        try {
          ...
          const apiUrl = `http://localhost:8080/firma-user`
        ...
        const fetchOptions = async () => {
          ...
          try {
            ...
            const [firmaRes] = await Promise.all([
              axios.get(`http://localhost:8080/firma-user/sign/${user.id}`, {
                headers: {
  ...
  return (
    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
                    ...
                    {editData.image && (
                        <Card>
                        <Image src={`http://localhost:8080/firma-user/${editData.image}`} width={150} height={150} alt="Firma de usuario" />
                       </Card>
                    )}
