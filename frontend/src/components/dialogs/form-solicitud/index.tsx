              ...
              <Card>
                <CardContent>
                  ...
                  <TextField
                    fullWidth
                    id='busqueda_input'
                    label='Buscar nombre, marca, modelo o placa/serial'
                      ...
                      <List sx={{ width: '100%', bgcolor: 'background.paper' }}>
                        {selectedProducts.map(value => {
                          ...
                          return (
                            ...
                            sx={{border:'1px solid lime', marginBottom:'5px', borderRadius:'5px', width:'100%'}}
                            >
                              <ListItemButton role={undefined} onClick={handleToggle(value)} dense>
                                ...
                                <ListItemText id={labelId} primary={`Nombre: ${value.productName}`} secondary={
      `Marca: ${value.brand ?? ''}  |  Modelo: ${value.model ?? ''}  |  Serial/Placa: ${value.licensePlate ?? value.serial ?? ''}`
    }/>
                    ...
                    {filteredProducts.map(value => {
                      ...
                      if (rowSelect.idSolicitud && value.id === editData.idEquipo) {
                        ...
                        return (
                          ...
                          <ListItem
                            key={value.id}
                            sx={{border:'1px solid blue', marginBottom:'5px', borderRadius:'5px', width:'100%'}}
                            disablePadding
                          >
                            <ListItemButton role={undefined} onClick={handleToggle(value)} dense>
                              <ListItemIcon>
